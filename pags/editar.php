...
<form action="editar.php" method="post">
    <?php
    $query = "SELECT * FROM producto2 WHERE id = " . $_REQUEST['id'];
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        <input type="text" class="form-control" name="apellidos" id="apellidos" value="<?php echo $row['apellidos']; ?>">
        </div>
        <br>
        <div class="col-md-4">
        ...
        <br>
        <div class="col-md-4">
        <button class="btn btn-dark" type="submit" name="guardar"><span class="bi bi-cloud-download-fill">Editar</button>  </span>
        <br>
        <br>
        <a class="btn btn-dark" href="eliminar.php?id=<?php echo $row['id'];?>"><center><span class="bi bi-person-x-fill"> Eliminar</center></span></a>
        </div>
        <?php
    }
    ?>
...
if ( isset( $_REQUEST['guardar'])) {
    $query = "UPDATE producto2 SET nombre='" . $_POST['nombre'] . "', apellidos='" . $_POST['apellidos'] . "', correo='" . $_POST['correo'] . "', edad='" . $_POST['edad'] . "' WHERE id=" . $_REQUEST['id'];
