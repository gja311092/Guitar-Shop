...
<br>
        ...
        <h2>¡Inicia Sesión!</h2>
          ...
          <br>
          <br>
          <input class="btn btn-dark" type="submit" name="btningresar" value="Iniciar Sesion"/>
          </div>
          </form>
      </div>
    </div>    
    ...
    <h2>o</h2> 
    <br>
    <a class="btn btn-dark" href="registro.php">Registrate</a>
<?php
...
if(isset($_POST['btningresar']))
{
  ...
  $query=mysqli_query($conn,"Select * from inicio where id = '".$id."' and password = '".$password."'");
  ...
  if($nr == 1)
  {
    $_SESSION['iddelusuario']=$id;
    header("location: CerrarSesion.php");
  }
  else if ($nr == 0)
  {
    echo "";
    echo "<center><h2>Usuario/contraseña inválida</h2></center>";
  }
  }
}
?>
